...
<p align="center">
  ...
  <a href="https://travis-ci.org/wo1261931780" rel="nofollow">
    <img src="https://travis-ci.org/wo1261931780.svg?branch=master" alt="Estado de Construcción">
  </a>
  <a href="https://github.com/wo1261931780/blob/master/LICENSE">
    <img src="https://img.shields.io/github/license/mashape/apistatus.svg" alt="Licencia">
  </a>
  <a href="https://github.com/wo1261931780/releases">
    <img src="https://img.shields.io/github/release/wo1261931780.svg" alt="Liberación Github">
  </a>
...
- [Enlace de Wiki](https://github.com/wo1261931780/wiki)
...
- [awesome-project](https://github.com/wo1261931780/issues/2312)

**Después de la versión `v4.1.0+`, la rama por defecto master no tendrá soporte para i18n. Por favor utilice la rama [i18n](https://github.com/wo1261931780/tree/i18n), los cambios serán incluidos en la rama master**

**la versión actual es `v4.0+` construida con `vue-cli`. Si encuentra algún problema, por favor coloque un [issue](https://github.com/wo1261931780/issues/new). Si desea usar la versión anterior, puede cambiar de rama a [tag/3.11.0](https://github.com/wo1261931780/tree/tag/3.11.0), no relacionado con `vue-cli`**
...
[![Edit on CodeSandbox](https://codesandbox.io/static/img/play-codesandbox.svg)](https://codesandbox.io/s/github/wo1261931780/tree/CodeSandbox)
...
### Akveo
<a href="https://store.akveo.com/products/vue-java-admin-dashboard-spring?utm_campaign=akveo_store-Vue-Vue_demo%2Fgithub&utm_source=vue_admin&utm_medium=referral&utm_content=github_banner"><img width="500px" src="https://raw.githubusercontent.com/wo1261931780-site/master/docs/.vuepress/public/images/vue-java-banner.png" /></a><p>Java backend integration</p>
...
```bash
# clone el proyecto
git clone https://github.com/wo1261931780.git
...
Los cambios detallados por cada liberación se encuentran en [notas de liberación](https://github.com/wo1261931780/releases).
...
[MIT](https://github.com/wo1261931780/blob/master/LICENSE)
