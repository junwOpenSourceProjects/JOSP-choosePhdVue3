 ...
 * @Date: 2024-02-07 17:35:34
 * @LastEditors: junw wo1261931780@gmail.com
 * @LastEditTime: 2024-02-07 22:18:35
 * @FilePath: \JOSP-BillDesktopVue\src\views\echartTestPage\echartZheXian10.vue
 * @Description: 1111
 *
  ...
  created() {
    days.forEach((day, idx) => {
      ...
      series.push({
        ...
        type: 'scatter',
        data: [], // Add your scatter plot data here
        symbolSize: function(dataItem) {
          return dataItem[1] * 4 // Adjust the symbol size calculation
        }
      })
    })
