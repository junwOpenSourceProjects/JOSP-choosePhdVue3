...
describe('Utils:validate', () => {
  ...
  it('validURL', () => {
    expect(validURL('https://github.com/wo1261931780')).toBe(true)
    expect(validURL('http://github.com/wo1261931780')).toBe(true)
    expect(validURL('github.com/wo1261931780')).toBe(false)
  })
  it('validLowerCase', () => {
